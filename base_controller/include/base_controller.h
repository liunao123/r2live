...
/*****************************		数据帧位置定义	********************/
#define HEAD_ONE				0x00
#define HEAD_TWO				0X01
#define LENGTH                                  0x02
#define OBJ				        0X03
#define PARAM1					0X05
#define PARAM2					0X06
...
/*****************************		数据帧内容定义	********************/
//帧头
#define ROS_FRAME_HEAD_ONE			0XAA
#define ROS_FRAME_HEAD_TWO			0x55
//对象
#define BEEP_OBJ				0X84	//蜂鸣器对象
#define MOTION_OBJ				0x01  	//运动对象
